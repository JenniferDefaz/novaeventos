...
# En producción usa Cloudinary; en local usa el sistema de archivos normal.
...
if CLOUDINARY_URL:
    ...
    # Desarrollo local: guardar en carpeta media/
    MEDIA_URL = '/media/'
...
EMAIL_USE_SSL = True
EMAIL_USE_TLS = False
EMAIL_HOST_USER = 'jennifer.defaz3511@utc.edu.ec'
EMAIL_HOST_PASSWORD = 'dwogdivylzffohjw'
